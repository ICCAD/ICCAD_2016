...
void writegds(const char *outputfile,vector<polygon> rectdata,int layer, int xbound, int ybound, int baselayer)
{
    if (layer==0) {
	...
	for (int k=0; k<rectdata.size(); k++) { //until area fit
		...
		points rectpoints[5];
		rectpoints[0].x=rectdata[k].xLeft;
		rectpoints[0].y=rectdata[k].yDown;
		rectpoints[1].x=rectdata[k].xLeft;
		rectpoints[1].y=rectdata[k].yUp;
		rectpoints[2].x=rectdata[k].xRight;
		rectpoints[2].y=rectdata[k].yUp;
		rectpoints[3].x=rectdata[k].xRight;
		rectpoints[3].y=rectdata[k].yDown;
		rectpoints[4].x=rectdata[k].xLeft;
		rectpoints[4].y=rectdata[k].yDown;
		for (int l=0; l<5; l++) {
